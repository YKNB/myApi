package com.vkstech.elasticsearch.videos.controller;
...
import com.vkstech.elasticsearch.videos.services.VideoService;
...
public class VideoController {
    ...
    public ResponseEntity<?> getImage(@RequestParam("imageName") Optional<String> name) throws IOException {
        ...
        var imgFile = new PathResource("/Users/mac/Documents/Cours_ETNA/TIC-YOUTUBE/myYoutubeV2/mono/backend/upload-dir/"+ name.get());
    ...
    public ResponseEntity<?> getVideoFile(@RequestParam("videoName") Optional<String> name) throws IOException {
        ...
        var videoFile = new PathResource("/Users/mac/Documents/Cours_ETNA/TIC-YOUTUBE/myYoutubeV2/mono/backend/upload-dir/"+ name.get());
