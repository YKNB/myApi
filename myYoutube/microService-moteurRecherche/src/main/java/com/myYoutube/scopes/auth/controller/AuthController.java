package com.myYoutube.scopes.auth.controller;

import com.myYoutube.scopes.auth.forms.EditForm;
import com.myYoutube.scopes.auth.forms.LoginDto;
import com.myYoutube.scopes.auth.forms.SignUpDto;
import com.myYoutube.scopes.auth.payload.response.JwtResponse;
import com.myYoutube.scopes.auth.payload.response.MessageResponse;
import com.myYoutube.scopes.security.CustomAuthenticationProvider;
import com.myYoutube.scopes.security.StaticUtils;
import com.myYoutube.scopes.token.TokenServiceImpl;
import com.myYoutube.scopes.user.entities.User;
import com.myYoutube.scopes.user.services.UserService;
